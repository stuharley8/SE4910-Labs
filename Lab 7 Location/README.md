I started with the Base project from https://github.com/android/location-samples/tree/main/BasicLocation/
described below and added on some additional features.
